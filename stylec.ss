...
.hero-terminal:hover {
    ...
    box-shadow:
        0 15px 45px rgba(0, 255, 136, 0.08);
}
...
.project-card:hover {
    ...
    box-shadow:
        0 15px 40px rgba(0, 255, 136, 0.12);
}
